...
The data for GDP Per Capita comes from World Bank data. If World Bank data is unavailable (as is the case with Cuba and Venezuela), the CIA Factbook is used. The data is lagged one year compared to the event. If this data is unavailable, data from the nearest previous year is used. 
