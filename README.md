...
Special thanks to Lewis Nguyen for his friendship and advice during the course of this project.

The list of revolutions is partially taken from the Introducton to Jack A. Goldstone, Leonid Grinin, and Andrey Korotayev's book, "Handbook of Revolutions in the 21st Century", as well as from the Wikipedia page, "List of Revolutions and Rebellions", adjusted to fit my definition of revolution.

The data for GDP Per Capita comes from World Bank data. If World Bank data is unavailable (as is the case with Cuba and Venezuela), the CIA Factbook is used. The Fragile State indicators are published by the Fund for Peace. These data are subject to a one year time-lag treaetment to account for the structural nature of revolutions.
